...
いまですらUSB/Bluetoothテンキーを接続すればホーム画面([Kvaesitso Launcher](https://github.com/MM2-0/Kvaesitso)など)から電話を発信できます。あとは物理キー12キーによる文字入力ですが、過去に何度から試みられてきましたので、これも時間が経てば解決する問題であると思われます。さらに重量や連続稼働時間に関しても技術革新で有利性を失いつつあると考えられます。

結果としてどうなるかというと、スマートウォッチやスマートグラスと連携できるハンドセットみたいな扱いになるのかもしれませんね。そしてこの流れは家庭用固定電話機も巻き込むのではないかと思います (あっちは通話できる冷蔵庫になるような)。
