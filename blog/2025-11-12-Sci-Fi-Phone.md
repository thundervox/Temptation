...
いまですらUSB/Bluetoothテンキー(あるいはBlackberryキーボード)を接続すればホーム画面([Kvaesitso Launcher](https://github.com/MM2-0/Kvaesitso)など)から電話を発信できます。あとは物理キー12キーによる文字入力ですが、過去に 因幡電気産業 iTwins OP-STCO1 や NicoWnnG など何度か改善は試みられてきましたので、これも時間が経てば解決する問題であると思われます (長文書くだけなら捨て値で売られているBluetooth対応3Gフィーチャーフォンを中古で手に入れたら良いだけですが)。さらに重量や連続稼働時間に関しても技術革新で有利性を失いつつあると考えられます。
